...
for (let i = 0; i < 2; i++) {
  ...
  if((typeof(a)) === "string" && (typeof(a)) != null && (typeof(b)) === "string" && (typeof(b) != null) && a != '' 
  && b != '' && a.length < 50){
    console.log('done');
    appData.expenses[a] = b;
  } else {
    if (a){ 
      a = prompt("Введите коректно обязательную статью расходов в этом месяце", ''); 
    }
    if (b){
      b = prompt("Введите коректно во сколько обойдется?", '');
  } 
  }
